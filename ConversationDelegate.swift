struct ConversationDelegate {
    func responseTo(question: String) -> String {
        ...
        if lowerQuestion == "o que é cringe?" {
            return "Hábitos vergonhosos de pessoas mais velhas."
        }
        ...
        if lowerQuestion == "que horas são?" {
            return "Hora de relaxar e conversar um pouco."
        }
        
        if lowerQuestion == "onde estou?" {
            return "Não tenho acesso a sua localização"
        }
        
        if lowerQuestion == "a pandemia acabou?" {
            return "Não"
        }
        ...
        if lowerQuestion.hasPrefix("quanto") {
            return "Eu precisaria fazer cálculos e agora não quero."
        }
